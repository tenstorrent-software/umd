...
class tt_SiliconDevice: public tt_device
{
    ...
    static constexpr std::uint32_t NON_EPOCH_ETH_CORES_START_ID = 12;
    ...
    static constexpr std::uint32_t EPOCH_ETH_CORES_START_ID = 6;
    ...
    tt_cxy_pair remote_transfer_ethernet_cores[16];
