...
// For fd cqs
void tt_SimulationDevice::write_to_sysmem(
...
void tt_SimulationDevice::read_from_sysmem(
...
flatbuffers::FlatBufferBuilder tt_SimulationDevice::create_flatbuffer(
    DEVICE_COMMAND rw, std::vector<uint32_t> vec, tt_cxy_pair core_, uint64_t addr, uint64_t size_) {
